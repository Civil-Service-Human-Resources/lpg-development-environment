...
APPS = [
    ...
    App("identity-service", JAVA_GRADLE, [JAVA_18_REQUIREMENT], LOCAL_DEVELOP_BRANCH),
    App("lpg-learner-record", JAVA_GRADLE, [JAVA_18_REQUIREMENT], LOCAL_DEVELOP_BRANCH),
    App("lpg-learning-catalogue", JAVA_GRADLE, [JAVA_18_REQUIREMENT], LOCAL_DEVELOP_BRANCH),
